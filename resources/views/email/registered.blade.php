                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Thank you so much for registering.  Please click the link below to confirm your account.</p>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="large-button">
                                                        <tr>
                                                            <td>
                                                                <a href="https://the9grounds.com/confirm/{{ $user->confirm_token }}">Confirm your account!</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <tr>
                                    <td class="wrapper last">
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <small style="color: gray">If the button doesn't work, paste https://the9grounds.com/confirm/{{ $user->confirm_token }} in your browser.</small>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
