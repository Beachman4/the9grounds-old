                                            ...
                                            <tr>
                                                <td>
                                                    <table class="large-button">
                                                        <tr>
                                                            <td>
                                                                <a href="https://the9grounds.com/forgot/{{ $token }}">Reset your password</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <small>If that button doesn't work, please paste this link into your web browser.<a href="https://the9grounds.com/forgot/{{ $token }}">https://the9grounds.com/forgot/{{ $token }}</a></small>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="wrapper last">
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <small style="color: gray">If you did not request this, please change your password immediately!</small>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                <td class="left-text-pad">
                                                    ...
                                                    <table class="tiny-button facebook">
                                                        <tr>
                                                            <td>
                                                                <a href="https://www.facebook.com/the9grounds">Facebook</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <br>
                                                    <table class="tiny-button twitter">
                                                        <tr>
                                                            <td>
                                                                <a href="https://twitter.com/the9grounds">Twitter</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table class="six columns">
                                            <tr>
                                                <td class="last right-text-pad">
                                                    <h5>The Nine Grounds</h5>
                                                    <a href="https://the9grounds.com">The Nine Grounds</a>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
