    ...
    var options = {
        ...
        setProgressBar = function ($el, score) {
            ...
            if (score < options.scores[0]) {
                progressbar.addClass("alert").removeClass("warning").removeClass("success");
                progressbar.find(".progress-meter").css("width", "5%");
                if (options.showVerdicts) {
                ...
                progressbar.addClass("warning").removeClass("alert").removeClass("success");
                ...
                progressbar.addClass("success").removeClass("warning").removeClass("alert");
        ...
        progressWidget = function () {
            return '<div class="progress"><div class="progress-meter"></div></div>';
        },
